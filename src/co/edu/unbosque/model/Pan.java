...
public class Pan extends Producto implements CapacidadAnejamiento {
	...
	public Pan(boolean tieneLevadura, String tipoHarina) {
		super();
		this.tieneLevadura = tieneLevadura;
		this.tipoHarina = tipoHarina;
	}

	public Pan(String nombre, float cantidad, int peso, int precio, boolean tieneLevadura, String tipoHarina) {
		super(nombre, cantidad, peso, precio);
		this.tieneLevadura = tieneLevadura;
		this.tipoHarina = tipoHarina;
	}

	public Pan(String nombre, float cantidad, int peso, int precio) {
		super(nombre, cantidad, peso, precio);
		// TODO Auto-generated constructor stub
	}
