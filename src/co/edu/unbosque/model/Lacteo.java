...
public class Lacteo extends Producto implements TipoCaducacionLactea {
	...
	public Lacteo(String marca, boolean tieneCambio) {
		super();
		this.marca = marca;
		this.tieneCambio = tieneCambio;
	}

	public Lacteo(String nombre, float cantidad, int peso, int precio, String marca, boolean tieneCambio) {
		super(nombre, cantidad, peso, precio);
		this.marca = marca;
		this.tieneCambio = tieneCambio;
	}

	public Lacteo(String nombre, float cantidad, int peso, int precio) {
		super(nombre, cantidad, peso, precio);
		// TODO Auto-generated constructor stub
	}
