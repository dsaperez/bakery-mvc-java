...
public class Galleta extends Producto implements CapacidadAnejamiento {
	...
	public Galleta(boolean tieneTopings, boolean tieneRelleno) {
		super();
		this.tieneTopings = tieneTopings;
		this.tieneRelleno = tieneRelleno;
	}

	public Galleta(String nombre, float cantidad, int peso, int precio, boolean tieneTopings, boolean tieneRelleno) {
		super(nombre, cantidad, peso, precio);
		this.tieneTopings = tieneTopings;
		this.tieneRelleno = tieneRelleno;
	}

	public Galleta(String nombre, float cantidad, int peso, int precio) {
		super(nombre, cantidad, peso, precio);
		// TODO Auto-generated constructor stub
	}
