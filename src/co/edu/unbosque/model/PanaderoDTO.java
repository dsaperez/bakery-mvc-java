...
public class PanaderoDTO extends Empleado {
	...
	public PanaderoDTO(int panesHorneadosPorDia, String especialidadPan) {
		super();
		this.panesHorneadosPorDia = panesHorneadosPorDia;
		this.especialidadPan = especialidadPan;
	}

	public PanaderoDTO(String nombreCompleto, String genero, int edad, String numTelefono, float salario,
