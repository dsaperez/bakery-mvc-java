...
public class Repostero extends Empleado {
	...
	public Repostero(int nivelCreatividad, boolean manejaTecnicasAvanzadas) {
		super();
		this.nivelCreatividad = nivelCreatividad;
		this.manejaTecnicasAvanzadas = manejaTecnicasAvanzadas;
	}

	public Repostero(String nombreCompleto, String genero, int edad, String numTelefono, float salario,
