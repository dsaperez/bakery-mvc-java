...
public class PostreDTO extends Producto implements CapacidadDeDeterioro {
	...
	public PostreDTO(boolean tieneAzucar, String tipoPostre) {
		super();
		this.tieneAzucar = tieneAzucar;
		this.tipoPostre = tipoPostre;
	}

	public PostreDTO(String nombre, float cantidad, int peso, int precio, boolean tieneAzucar, String tipoPostre) {
		super(nombre, cantidad, peso, precio);
		this.tieneAzucar = tieneAzucar;
		this.tipoPostre = tipoPostre;
	}

	public PostreDTO(String nombre, float cantidad, int peso, int precio) {
		super(nombre, cantidad, peso, precio);
		// TODO Auto-generated constructor stub
	}
