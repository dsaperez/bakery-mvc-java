...
public class PanelRepostero extends JPanel {
	...
	private JLabel labelCreatividad;
	...
	private TextField campoTextoCreatividad;
	private JCheckBox campoTextoTecnicas;

	public PanelRepostero() {

		this.setBounds(0, 0, 800, 700);
		this.setBackground(new Color(189, 179, 143));
		setLayout(null);

		titulo = new JLabel("ADMINISTRACION DE REPOSTEROS");
		...
		labelCreatividad = new JLabel("Nivel creatividad (1-10):");
		labelCreatividad.setBounds(200, 170, 160, 20);
		add(labelCreatividad);

		campoTextoCreatividad = new TextField();
		campoTextoCreatividad.setBounds(200, 190, 150, 25);
		add(campoTextoCreatividad);

		campoTextoTecnicas = new JCheckBox("Maneja tecnicas avanzadas");
		campoTextoTecnicas.setBounds(370, 185, 220, 25);
		campoTextoTecnicas.setBackground(new Color(189, 179, 143));
		add(campoTextoTecnicas);
	...
	public void aplicarIdioma(Properties prop) {
		titulo.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.titulo"));
		labelNombre.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.labelNombre"));
		labelGenero.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.labelGenero"));
		labelEdad.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.labelEdad"));
		labelTelefono.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.labelTelefono"));
		labelSalario.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.labelSalario"));
		labelCreatividad.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.labelCreatividad"));
		campoTextoTecnicas.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.checkTecnicas"));
		boton1.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.botonRegistro"));
		boton2.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.botonEliminar"));
		boton3.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.botonActualizar"));
		boton4.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.botonLista"));
		boton5.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.botonContar"));
		boton6.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.botonVolver"));
		boton7.setText(prop.getProperty("panaderia.aplicativo.interfaz.repostero.botonCalcularDiaTrabajo"));
	}
	...
	public TextField getCampoTextoCreatividad() {
		return campoTextoCreatividad;
	}

	public void setCampoTextoCreatividad(TextField campoTextoCreatividad) {
		this.campoTextoCreatividad = campoTextoCreatividad;
	}

	public JCheckBox getCampoTextoTecnicas() {
		return campoTextoTecnicas;
	}

	public void setCampoTextoTecnicas(JCheckBox campoTextoTecnicas) {
		this.campoTextoTecnicas = campoTextoTecnicas;
	}
