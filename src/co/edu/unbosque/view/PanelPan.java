...
public class PanelPan extends JPanel {
	...
	private JCheckBox campoTextoLevadura;
	private TextField campoTextoHarina;
	...
	public PanelPan() {
		...
		titulo = new JLabel("ADMINISTRACION DE PANES");
		...
		campoTextoLevadura = new JCheckBox(" Tiene levadura ");
		campoTextoLevadura.setBounds(30, 170, 150, 25);
		campoTextoLevadura.setBackground(new Color(189, 179, 143));
		add(campoTextoLevadura);

		labelHarina = new JLabel("Tipo de harina:");
		labelHarina.setBounds(200, 165, 120, 20);
		add(labelHarina);

		campoTextoHarina = new TextField();
		campoTextoHarina.setBounds(200, 185, 150, 25);
		add(campoTextoHarina);
	...
	public void aplicarIdioma(Properties prop) {
		titulo.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.titulo"));
		labelNombre.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.labelNombre"));
		labelCantidad.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.labelCantidad"));
		labelPeso.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.labelPeso"));
		labelPrecio.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.labelPrecio"));
		labelHarina.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.labelHarina"));
		campoTextoLevadura.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.checkLevadura"));
		boton1.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.botonRegistro"));
		boton2.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.botonEliminar"));
		boton3.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.botonActualizar"));
		boton4.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.botonLista"));
		boton5.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.botonContar"));
		boton6.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.botonVolver"));
		boton7.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.botonVerificarVencimiento"));
		boton8.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.botonPrecioTotal"));
		boton9.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.botonVerificarEndurecimiento"));
		boton10.setText(prop.getProperty("panaderia.aplicativo.interfaz.pan.botonRegistroIngredientes"));
	}
	...
	public JCheckBox getCampoTextoLevadura() {
		return campoTextoLevadura;
	}

	public void setCampoTextoLevadura(JCheckBox campoTextoLevadura) {
		this.campoTextoLevadura = campoTextoLevadura;
	}

	public TextField getCampoTextoHarina() {
		return campoTextoHarina;
	}

	public void setCampoTextoHarina(TextField campoTextoHarina) {
		this.campoTextoHarina = campoTextoHarina;
	}
