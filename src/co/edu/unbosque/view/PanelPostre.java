...
public class PanelPostre extends JPanel {
	...
	private JCheckBox campoTextoAzucar;
	private TextField campoTextoTipoPostre;
	...
	public PanelPostre() {
		...
		titulo = new JLabel("ADMINISTRACION DE POSTRES");
		...
		campoTextoAzucar = new JCheckBox(" Tiene Azucar ");
		campoTextoAzucar.setBounds(30, 170, 150, 25);
		campoTextoAzucar.setBackground(new Color(189, 179, 143));
		add(campoTextoAzucar);

		labelPostre = new JLabel("Tipo de Postre:");
		labelPostre.setBounds(200, 165, 150, 20);
		add(labelPostre);

		campoTextoTipoPostre = new TextField();
		campoTextoTipoPostre.setBounds(200, 185, 150, 25);
		add(campoTextoTipoPostre);
		...
		boton9 = new JButton(" Verificar Deterioro ");
	...
	public void aplicarIdioma(Properties prop) {
		titulo.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.titulo"));
		labelNombre.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.labelNombre"));
		labelCantidad.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.labelCantidad"));
		labelPeso.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.labelPeso"));
		labelPrecio.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.labelPrecio"));
		labelPostre.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.labelTipoPostre"));
		campoTextoAzucar.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.checkAzucar"));
		boton1.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.botonRegistro"));
		boton2.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.botonEliminar"));
		boton3.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.botonActualizar"));
		boton4.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.botonLista"));
		boton5.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.botonContar"));
		boton6.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.botonVolver"));
		boton7.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.botonVerificarVencimiento"));
		boton8.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.botonPrecioTotal"));
		boton9.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.botonVerificarDeterioro"));
		boton10.setText(prop.getProperty("panaderia.aplicativo.interfaz.postre.botonRegistroIngredientes"));
	}
	...
	public JCheckBox getCampoTextoAzucar() {
		return campoTextoAzucar;
	}

	public void setCampoTextoAzucar(JCheckBox campoTextoAzucar) {
		this.campoTextoAzucar = campoTextoAzucar;
	}

	public TextField getCampoTextoTipoPostre() {
		return campoTextoTipoPostre;
	}

	public void setCampoTextoTipoPostre(TextField campoTextoTipoPostre) {
		this.campoTextoTipoPostre = campoTextoTipoPostre;
	}
