...
public class PanelMesero extends JPanel {
	...
	private JCheckBox campoTextoEstudia;
	private JCheckBox campoTextoEvento;
	...
	public PanelMesero() {
		...
		titulo = new JLabel("ADMINISTRACION DE MESEROS");
		...
		campoTextoEstudia = new JCheckBox("Estudia?");
		campoTextoEstudia.setBounds(200, 185, 150, 25);
		campoTextoEstudia.setBackground(new Color(189, 179, 143));
		add(campoTextoEstudia);

		campoTextoEvento = new JCheckBox("Experiencia en eventos grandes?");
		campoTextoEvento.setBounds(370, 180, 220, 25);
		campoTextoEvento.setBackground(new Color(189, 179, 143));
		add(campoTextoEvento);
	...
	public void aplicarIdioma(Properties prop) {
		titulo.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.titulo"));
		labelNombre.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.labelNombre"));
		labelGenero.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.labelGenero"));
		labelEdad.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.labelEdad"));
		labelTelefono.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.labelTelefono"));
		labelSalario.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.labelSalario"));
		campoTextoEstudia.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.checkEstudia"));
		campoTextoEvento.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.checkEvento"));
		boton1.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.botonRegistro"));
		boton2.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.botonEliminar"));
		boton3.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.botonActualizar"));
		boton4.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.botonLista"));
		boton5.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.botonContar"));
		boton6.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.botonVolver"));
		boton7.setText(prop.getProperty("panaderia.aplicativo.interfaz.mesero.botonCalcularDiaTrabajo"));
	}
	...
	public JCheckBox getCampoTextoEstudia() {
		return campoTextoEstudia;
	}

	public void setCampoTextoEstudia(JCheckBox campoTextoEstudia) {
		this.campoTextoEstudia = campoTextoEstudia;
	}

	public JCheckBox getCampoTextoEvento() {
		return campoTextoEvento;
	}

	public void setCampoTextoEvento(JCheckBox campoTextoEvento) {
		this.campoTextoEvento = campoTextoEvento;
	}
