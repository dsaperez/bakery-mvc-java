...
public class PanelProveedorIndustrial extends JPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3440928901228358746L;
	...
	public PanelProveedorIndustrial() {

		this.setBounds(0, 0, 800, 700);
		this.setBackground(new Color(189, 179, 143));
		setLayout(null);

		titulo = new JLabel("PROVEEDORES INDUSTRIALES");
	...
	public void aplicarIdioma(Properties prop) {
		titulo.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.titulo"));
		labelNombre.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.labelNombre"));
		labelNIT.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.labelNIT"));
		labelCiudad.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.labelCiudad"));
		labelTelefono.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.labelTelefono"));
		labelProducto.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.labelProducto"));
		campoTextoInvima.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.checkInvima"));
		boton1.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.botonRegistro"));
		boton2.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.botonEliminar"));
		boton3.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.botonActualizar"));
		boton4.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.botonLista"));
		boton5.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.botonContar"));
		boton6.setText(prop.getProperty("panaderia.aplicativo.interfaz.proveedorIndustrial.botonVolver"));
	}
