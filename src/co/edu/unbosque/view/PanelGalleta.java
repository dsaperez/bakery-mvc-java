...
public class PanelGalleta extends JPanel {
	...
	private JCheckBox campoTextoTopings;
	private JCheckBox campoTextoRelleno;
	...
	public PanelGalleta() {
		...
		titulo = new JLabel("ADMINISTRACION DE GALLETAS");
		...
		campoTextoTopings = new JCheckBox(" Tiene Topings? ");
		campoTextoTopings.setBounds(30, 170, 150, 25);
		campoTextoTopings.setBackground(new Color(189, 179, 143));
		add(campoTextoTopings);

		campoTextoRelleno = new JCheckBox(" Tiene Relleno? ");
		campoTextoRelleno.setBounds(200, 170, 150, 25);
		campoTextoRelleno.setBackground(new Color(189, 179, 143));
		add(campoTextoRelleno);

		boton1 = new JButton(" Registro ");
		boton1.setBounds(30, 220, 170, 50);
		...
		boton2.setBounds(220, 220, 170, 50);
		...
		boton3.setBounds(410, 220, 170, 50);
		...
		boton4.setBounds(600, 220, 170, 50);
		...
		boton5.setBounds(30, 290, 170, 50);
		...
		boton6.setBounds(410, 360, 170, 50);
		...
		boton7.setBounds(410, 290, 170, 50);
		...
		boton8.setBounds(600, 290, 170, 50);
		...
		boton9 = new JButton(" Verificar Endurecimiento ");
		boton9.setBounds(220, 290, 170, 50);
		...
		boton10.setBounds(220, 360, 170, 50);
	...
	public void aplicarIdioma(Properties prop) {
		titulo.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.titulo"));
		labelNombre.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.labelNombre"));
		labelCantidad.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.labelCantidad"));
		labelPeso.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.labelPeso"));
		labelPrecio.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.labelPrecio"));
		campoTextoTopings.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.checkTopings"));
		campoTextoRelleno.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.checkRelleno"));

		boton1.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.botonRegistro"));
		boton2.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.botonEliminar"));
		boton3.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.botonActualizar"));
		boton4.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.botonLista"));
		boton5.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.botonContar"));
		boton6.setText(prop.getProperty("panaderia.aplicativo.interfaz.buscar.botonVolver"));
		boton7.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.botonVerificarVencimiento"));
		boton8.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.botonPrecioTotal"));
		boton9.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.botonVerificarEndurecimiento"));
		boton10.setText(prop.getProperty("panaderia.aplicativo.interfaz.galleta.botonRegistroIngredientes"));
	}
	...
	public JCheckBox getCampoTextoTopings() {
		return campoTextoTopings;
	}

	public void setCampoTextoTopings(JCheckBox campoTextoTopings) {
		this.campoTextoTopings = campoTextoTopings;
	}

	public JCheckBox getCampoTextoRelleno() {
		return campoTextoRelleno;
	}

	public void setCampoTextoRelleno(JCheckBox campoTextoRelleno) {
		this.campoTextoRelleno = campoTextoRelleno;
	}
